...
features_incorporated = '[{"name":"kwargs","base":"v4.1.1"}]'

oarepo_major_version = "12"

package_oarepo_version = "oarepo-4.1.4"

configuration = '{"name": "invenio-requests", "oarepo": 12, "features": [{"name": "kwargs", "base": "v4.1.1"}], "package": "invenio-requests", "invenio_version": "4.1.4", "version": "4.1.4"}'
