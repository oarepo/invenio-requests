...
package_oarepo_version = "oarepo-7.2.1"

configuration = '{"name": "invenio-requests", "oarepo": 13, "features": [{"name": "kwargs-from-6.2.0", "base": "v6.2.0"}], "package": "invenio-requests", "invenio_version": "7.2.1", "version": "7.2.1"}'
